...
urlpatterns = [
    ...
    path('get_projects/',views.get_projects,name="api_get_projects"), # 获取空间列表
    path('get_docs/',views.get_docs,name="api_get_docs"), # 获取空间的文档列表
...
path('get_doc_previous_next/', views.get_doc_previous_next, name="api_get_doc_previous_next"),  # 获取文档上下篇文档
    path('create_project/',views.create_project,name="api_create_project"), # 新建空间
